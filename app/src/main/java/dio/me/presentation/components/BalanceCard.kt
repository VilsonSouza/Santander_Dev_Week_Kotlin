        ...
        Column(modifier= Modifier.padding(Spacing_2)) {
            Row(modifier= Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween){
                Row (modifier=Modifier.fillMaxWidth(0.8f)){
                    Icon(imageVector = Icons.Filled.CurrencyExchange, contentDescription ="Currency" )
                    Text(modifier= Modifier.padding(start = Spacing_3),text = "Saldo Disponível")
                }
                Icon(imageVector = Icons.Filled.ExpandLess, contentDescription = "Expand Less")

            }
            Text(text=balance.formatCurrency(),style= TextStyle(
                fontSize=32.4.sp,
            ...
            Text(text = "Saldo + Limite: ${(limit+balance).formatCurrency()}",
                style= TextStyle(
                    fontSize=18.sp,
            ...
            TextButton(modifier=Modifier.align(
