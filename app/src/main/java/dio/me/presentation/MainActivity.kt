    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            SantanderDevWeekTheme {
                MainApp(response = state.response)
            }
        }
    }
}
...
fun MainApp(response: Response? = null) =
    Surface(color = MaterialTheme.colorScheme.background) {
        Scaffold(
            topBar = { AppTopBar() },
            content = {
                innerPadding -> ConstraintLayout(modifier= Modifier.padding(innerPadding)) {
                    ...
                    MenuItems(
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(horizontal = Spacing_2, vertical = Spacing_3)
                    ...
                    NewsPagerApp(
                        ...
                        modifier = Modifier
                            .padding(
                                horizontal = Spacing_2, vertical = Spacing_2
                            )
                            .constrainAs(news) {
